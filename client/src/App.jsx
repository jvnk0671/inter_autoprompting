...
const RefinedPromptingService = () => {
  ...
  const [method, setMethod] = useState('coolprompt');
  ...
  const methodOptions = [{ value: 'coolprompt', label: 'CoolPrompt' }, { value: 'promptomatix', label: 'Promptomatix' }];
